...
If you're in need of a copy, DM me on Discord <span class="text=gradient">@brenno263</span> or Slack <span class="text-gradient">@brennan</span> and I can give a few pointers.
</CardSection>
...
The verson we're going with is <span class="text-gradient">2.0.13</span>. I'll make a fuss if we choose to update it.
### Step Two - Logging In
...
Then, enter the password, which is "simulacrum"
