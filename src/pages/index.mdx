...
If you're in need of a copy, DM me on Slack <a>@brennan</a> and I can give a few pointers.
</CardSection>

<CardSection title="Getting Started" collapsing={true} startCollapsed={false} client:idle>
First join <a href="https://discord.gg/SFwCsptr">the Discord Server</a>.
...
Factorio servers do not auto-update. So if your game updates you will no longer be able to access the server until I get around to updating it. I highly reccomend configuring your game to not auto-update.
...
- If you're on *Steam*, you can use your Steam login to grab a free non-Steam copy from factorio.com.
...
I'll publish the official version to use at server launch, so if it isn't listed here
please bother me about it <a>@brennan</a> on Slack.
### Step Two - Logging In
